...
const Header: React.FC = () => {
    ...
    const isCartOpen = useTypedSelector(state => state.cart.isOpen);
    ...
    return (
        <div className='header-container'>
            <div className='header-search-box'>
                ...
                <div>
                    <input onChange={handleFindBook} className='header-input' type="text" />
                    <span className='header-button'>Find</span>
                </div>
                <div>
                    <Tooltip placement="left" title="Discount">
                        <img onClick={showModal} className='header-img-discount' src={discountImg} alt="" />
                    </Tooltip>
                    ...
                    <Cart visible={isCartOpen} onOk={handleCloseCart} onCancel={handleCloseCart} />
                </div>
            </div>
        </div>
    )
